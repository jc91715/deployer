...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/admin/views/backend/project/Edit.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__("./node_modules/babel-runtime/regenerator/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_codemirror__ = __webpack_require__("./node_modules/vue-codemirror/dist/vue-codemirror.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_codemirror_lib_codemirror_css__ = __webpack_require__("./node_modules/codemirror/lib/codemirror.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_codemirror_theme_monokai_css__ = __webpack_require__("./node_modules/codemirror/theme/monokai.css");
...
__webpack_require__("./resources/assets/js/admin/lib/vendor/lou/multi-select/css/multi-select.css");
__webpack_require__("./resources/assets/js/admin/lib/vendor/lou/multi-select/js/jquery.multi-select.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            rules: {
                ...
                repository: [{ required: true, message: '请输入项目名称', trigger: 'blur' }],
                server_id: [{ required: true, message: '请选择服务器', trigger: 'blur' }],
                task_ids: [{ required: true, message: '请选择任务', trigger: 'blur' }],
                env: [{ required: true, message: '请输入项目环境配置', trigger: 'blur' }]
            },
            cmOptions: {
                // codemirror options
                tabSize: 4,
    ...
    components: {
        codemirror: __WEBPACK_IMPORTED_MODULE_2_vue_codemirror__["codemirror"]
    },
    methods: {
        ...
        submitForm: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(formName) {
                var state, _form, space_id, project_id, name, env, server_id, task_ids, repository;
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                this.loading = true;
                                _form = this.form, space_id = _form.space_id, project_id = _form.project_id, name = _form.name, env = _form.env, server_id = _form.server_id, task_ids = _form.task_ids, repository = _form.repository;
                                _context.next = 8;
                                return __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].dispatch('projectUpdate', { space_id: space_id, project_id: project_id, name: name, env: env, server_id: server_id, task_ids: task_ids, repository: repository });
    ...
    created: function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
            var data, _data$data$project, space_id, server_id, name, env, repository, form, vm;
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                            _context2.next = 4;
                            return __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].dispatch('projectShow', { space: this.id, project_id: this.project_id });

                        case 4:
                            data = _context2.sent;
                            _data$data$project = data.data.project, space_id = _data$data$project.space_id, server_id = _data$data$project.server_id, name = _data$data$project.name, env = _data$data$project.env, repository = _data$data$project.repository;
                            form = { space_id: space_id, server_id: server_id, name: name, env: env, repository: repository };

                            form.task_ids = _.map(data.data.project.tasks, 'id');

                            form.project_id = data.data.project.id;
                            if (!form.env) {
                                form.env = '';
                            }
                            this.form = form;
                            ...
                            this.$nextTick(function () {
                                $('#recipe_id_order').val(form.task_ids.join(','));
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/codemirror/theme/monokai.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
/***/ "./node_modules/css-loader/index.js!./node_modules/codemirror/theme/monokai.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48789cee\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/js/admin/views/backend/project/Edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./resources/assets/js/admin/lib/vendor/lou/multi-select/css/multi-select.css":
/***/ (function(module, exports, __webpack_require__) {
            ...
            [
              _c(
                ...
                [
                  ...
                  _c(
                    "el-form-item",
                    { attrs: { label: "服务器选择", prop: "server_id" } },
                    [
                      _c(
                        "el-select",
                        {
                        ...
                        _vm._l(_vm.servers, function(server, index) {
                          return _c("el-option", {
                            key: index,
                            attrs: { label: server.name, value: server.id }
                          })
                        }),
                        1
                      )
                  ...
                  _c(
                    "el-form-item",
                    { attrs: { label: "任务选择", prop: "task_ids" } },
                    [
                      _c(
                        "select",
                        {
                          staticClass: "multi-select",
                          attrs: { id: "recipe_id", multiple: "multiple" }
                        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48789cee", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48789cee\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/js/admin/views/backend/project/Edit.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48789cee\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/js/admin/views/backend/project/Edit.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("8123ca34", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48789cee\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48789cee\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./resources/assets/js/admin/lib/vendor/lou/multi-select/css/multi-select.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./resources/assets/js/admin/lib/vendor/lou/multi-select/css/multi-select.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!./multi-select.css", function() {
			var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!./multi-select.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/***/ "./resources/assets/js/admin/lib/vendor/lou/multi-select/img/switch.png":
/***/ (function(module, exports) {

module.exports = "/build/admin/images/switch.png?08f16e9c0ca538d7180aee98b96d6351";

/***/ }),

/***/ "./resources/assets/js/admin/lib/vendor/lou/multi-select/js/jquery.multi-select.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./resources/assets/js/admin/views/backend/project/Edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-48789cee\",\"hasScoped\":true,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/admin/views/backend/project/Edit.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-48789cee"
...
Component.options.__file = "resources/assets/js/admin/views/backend/project/Edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48789cee", Component.options)
  } else {
    hotAPI.reload("data-v-48789cee", Component.options)
  }
